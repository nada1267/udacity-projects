...
#some tricky notes for great fish
#num_ops: This parameter specifies the number of transformations to apply to each input image.(two random transformation will apply)
#magnitude:controls the strength or intensity of the transformations.
#interpolation: This parameter specifies the interpolation method 
#Bilinear Interpolation: A more sophisticated method that considers the four nearest pixels and performs a weighted average based on the distance from the transformed pixel.
